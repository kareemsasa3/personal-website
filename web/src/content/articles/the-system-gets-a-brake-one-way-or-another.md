---
slug: the-system-gets-a-brake-one-way-or-another
title: The System Gets a Brake One Way or Another
subtitle: Competitive escalation, consumed margins, and the difference between a correction you choose and one you don't
kind: essay
published: 2026-09-16
description: >-
  Why competitive systems can keep accelerating after everyone sees the danger—and how coordination determines whether correction is chosen or imposed.
---
...
1. the cars (participants);
2. being ahead (the relative-position variable);
3. acceleration (the escalating behavior);
4. the cost of unilateral restraint;
5. the buffer consumed;
6. the limiting mechanism if uncoordinated;
7. the available coordination mechanism.
